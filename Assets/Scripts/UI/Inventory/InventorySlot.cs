...
public class InventorySlot : MonoBehaviour
{
    ...
    private void SetDescriptions(Item item)
    {
        ...
        if (itemTypesTitles.TryGetValue(type, out (string, string) titlesDict))
        {
            ...
            foreach (Text title in titles)
            {
                ...
                if (itemTypesStats.TryGetValue(title.text, out int stat))
    ...
    {
        // Equip
        EquipUI.Instance.Equip(item, itemIndex);
    ...
    public bool Equiped => this.equiped;
}
